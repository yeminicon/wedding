...
const WeddingGuestForm = () => {
  return (
    <div
      className="w-[95%] md:max-w-[700px] rounded-full mx-auto "
      style={{
    ...
    >
      <div className="relative bg-white shadow-lg border-4  rounded-full max-w-lg mx-auto my-10 p-20">
        ...
        {/* Form Header */}
        <h1 className="text-3xl font-bold text-center text-pink-600 mb-4">Wedding Guest Form</h1>
        ...
        <form>
          {/* Are You Attending */}
          <div className="mb-6">
            <label className="block font-medium text-gray-700 mb-2">Are you attending?</label>
          ...
          {/* Meal Preferences */}
          <div className="mb-6">
            <label className="block font-medium text-gray-700 mb-2">Meal Preferences</label>
            <textarea
